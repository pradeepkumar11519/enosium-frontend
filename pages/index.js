...
export default function Home({ loading, setloading, setProgress }) {
	...
	return (
		<div className=' bg-cover bg-center w-full h-full'>
			...
			>
				...
				<div className='text-white mx-auto flex flex-col justify-center'>
					...
					<div>
						...
						{(result == 2) ? (
							<>
								<h1 ><TiTick className='w-[300px] h-[300px] rounded-full bg-green-500 text-white text-center my-auto mx-auto p-10 ' /></h1>
								<h1 className='text-xl font-bold text-center my-5'>You Can Handle Repaying The Loan</h1>
							</>

						) : (
							<>
								<h1 ><ImCross className='w-[300px] h-[300px] rounded-full bg-red-500 text-white text-center my-auto mx-auto p-10 ' /></h1>
								<h1 className='text-xl font-bold text-center my-5'>It Is Not Recommended For You To Take The Loan</h1>
							</>
						)}
					</div>
			...
			<div className=' bg-[url("/images/home1.png")] bg-bl  w-full h-full '>
				<Bounce top>
				...
				<form className='sm:py-32 sm:mx-32 mx-5 py-32 uppercase' onSubmit={onSubmit} action="post">
					...
					<div>
						<div className='relative'>
							<div className=' absolute invert inset-0 bg-gradient-to-r from-pink-600 to-purple-500 text-center '>
							<button className='hover:scale-105 focus:ring-4 i focus:ring-rose-600 bg-white  focus:ring-opacity-50 transition-all fade-in-out p-3 font-bold  text-xl rounded-md mx-auto '>{loading ? "Loading..." : "Submit"}</button>
							</div>
							
						</div>

					</div>
					{/* <button className='hover:scale-105 focus:ring-4 i focus:ring-rose-600 focus:ring-opacity-50 transition-all fade-in-out p-3 font-bold  text-xl rounded-md mx-auto '>{loading ? "Loading..." : "Submit"}</button> */}
				</form>
				<style jsx>
					{
						`
